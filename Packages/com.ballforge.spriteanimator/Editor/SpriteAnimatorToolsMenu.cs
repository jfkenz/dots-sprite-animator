...
namespace BallForge.Sprites.DOTS.Editor
{
    ...
    {
        const string QuickStartPath = "Packages/com.ballforge.spriteanimator/Documentation~/QuickStart.md";
        const string ReadmePath = "Packages/com.ballforge.spriteanimator/README.md";
        ...
        public static void OpenHelp()
        {
            ...
            string fallback = $"file://{Application.dataPath}/../Packages/com.ballforge.spriteanimator/README.md";
